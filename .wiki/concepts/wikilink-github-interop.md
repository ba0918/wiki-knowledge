...
執筆体験（Obsidian / Foam / Dendron でのオートコンプリートとバックリンク）を取るか、GitHub 上での追跡性を取るかのトレードオフが発生する。本プロジェクトは前者を採り、補完策として lint と `## 関連` 併記方式を採用している。詳細は [[wikilink-conversion-strategies]] ([↗](wikilink-conversion-strategies.md)) を参照。

## 関連

- [[wikilink-reader-comparison]] ([↗](wikilink-reader-comparison.md)) — どのリーダーが wikilink をどう解釈するか
- [[wikilink-conversion-strategies]] ([↗](wikilink-conversion-strategies.md)) — `[[…]]` ↔ 標準リンクの変換戦略
- [[wikilink-link-parser-spec]] ([↗](wikilink-link-parser-spec.md)) — 本プロジェクト lint の wikilink 抽出仕様
