...
4. python3 skills/wiki/scripts/graph_gen.py --wiki-root {wiki_root}
...
2. python3 skills/wiki/scripts/graph_gen.py --wiki-root {wiki_root}
...
```
1. python3 skills/wiki/scripts/graph_gen.py --wiki-root {wiki_root}
